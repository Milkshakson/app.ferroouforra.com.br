<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <!-- End Logo -->
    <?php if (is_array(session('openedSession'))) { ?>
        <!--  Searchbar -->
        <h5 class="card-title">
        ...
        <nav class="header-nav ms-auto">
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3"><a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <i class="bi bi-person"></i> <span class="d-none d-md-block dropdown-toggle ps-2"> <?= session('usuarioTokenAcesso')->sub ?></span>
                    </a> <!-- End Profile Iamge Icon -->
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            <h6>
                                <?= session('usuarioTokenAcesso')->sub ?>
                            </h6> <span><?= session('usuarioTokenAcesso')->environment ?></span>
                        </li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
