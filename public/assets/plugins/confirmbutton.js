...
(function(exports, document) {
        ...
        return createTag(".modal.fade", { tabindex : "-1", role : "dialog", "aria-hidden" : "true", "data-keyboard": "true"  })._append(
            createTag(".modal-dialog.modal-dialog-centered", { role : "document" })._append(
                createTag(".modal-content")._append(
                    createTag(".modal-header.bg-danger.text-light")._append(
                    ...
                    createTag(".modal-footer")._append(
                        createTag("button.btn.btn-primary.confirm", { type: "button" }, "Confirmar"),
                        createTag("button.btn.btn-secondary.cancel", { type: "button" }, "Cancelar"),
                    )
                )
            )
        )
    ...
    defaults = {
        confirm: "Por favor, confirme esta ação.",
        texttarget: "p.message",
        titletarget: ".modal-title h5",
        titletxt: "Esta ação requer uma confirmação",
    ...
    let defaults_verification = {
        errormsg: "A ação não pode prosseguir porque a confirmação falhou",
        verify: () => true,
        errormsgtarget: "p.message",
        titletarget: ".modal-title h5",
        errortitletxt: "Falha na confirmação",
